# Welcome to the code behind the Unofficial Columbus Civic Associatoins website
...
Please [open an issue](https://github.com/benlk/columbus-civic-associations/issues/new/choose) and provide a detailed description of what needs to happen. There's a specific template for suggesting new plans.
...
Please send [a GitHub Pull Request to this repository](https://github.com/benlk/columbus-civic-associations/pull/new/master) with a clear list of changes made (read more about [pull requests](http://help.github.com/pull-requests/)). If you're making changes to CSS, JS, or HTML, please follow the existing code standards with regards to indentation. 
